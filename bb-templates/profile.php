...
<p><?php printf(__('This is how your profile appears to a fellow logged in member, you may <a href="%1$s">edit this information</a>. You can also <a 
href="%2$s">manage your favorites</a> and subscribe to your favorites&#8217; <a href="%3$s"><abbr title="Really Simple Syndication">RSS</abbr> feed</a>'), 
wp_specialchars(get_profile_tab_link( $user_id, 'edit' )), wp_specialchars(get_favorites_link()), wp_specialchars(get_favorites_rss_link())); ?></p>
<?php endif; ?>
