# bbPress 2.6 maintenance branch

[![PHPUnit Tests](https://github.com/bbpress/bbPress/actions/workflows/test.yml/badge.svg?branch=2.6)](https://github.com/bbpress/bbPress/actions/workflows/test.yml)
[![Lint](https://github.com/bbpress/bbPress/actions/workflows/lint.yml/badge.svg?branch=2.6)](https://github.com/bbpress/bbPress/actions/workflows/lint.yml)
[![Build and Smoke Test](https://github.com/bbpress/bbPress/actions/workflows/build-smoke.yml/badge.svg?branch=2.6)](https://github.com/bbpress/bbPress/actions/workflows/build-smoke.yml)
...
Code on `branches/2.6` contains maintenance work for future 2.6 patch releases
and is not intended for production sites. Browse released source tags in
...
2.6, install dependencies, open the local site, verify bbPress, run a focused
