...
?>
	...
	<input class="submit" type="submit" name="submit" id="submit" value="<?php _e('Update Settings &raquo;') ?>" />
</form>
...
?>
	...
	<input class="submit" type="submit" name="submit" id="submit" value="<?php _e('Update User Role Map &raquo;') ?>" />
</form>
