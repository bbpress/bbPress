...
if ( isset( $_GET['rsd'] ) ) {
	...
	echo '			<api name="Movable Type" blogID="1" preferred="false" apiLink="' . bb_get_uri( 'xmlrpc.php' ) . '" />' . "\n";
	echo '			<api name="MetaWeblog" blogID="1" preferred="false" apiLink="' . bb_get_uri( 'xmlrpc.php' ) . '" />' . "\n";
	echo '			<api name="Blogger" blogID="1" preferred="false" apiLink="' . bb_get_uri( 'xmlrpc.php' ) . '" />' . "\n";
	//echo '			<api name="Atom" blogID="" preferred="false" apiLink="' . apply_filters( 'bb_atom_service_url', bb_get_uri( 'bb-app.php/service' ) ) . '" />' . "\n";
	echo '		</apis>' . "\n";
	echo '	</service>' . "\n";
	echo '</rsd>' . "\n";
	exit;
...
// TODO				'bb.getHotTopicTags'   => 'this:bb_getHotTopicTags',
				...
				//'wp.getPage'              => 'this:wp_getPage',     // Not implemented
				//'wp.getPages'             => 'this:wp_getPages',    // Not implemented
				//'wp.newPage'              => 'this:wp_newPage',     // Not implemented
				//'wp.deletePage'           => 'this:wp_deletePage',  // Not implemented
				//'wp.editPage'             => 'this:wp_editPage',    // Not implemented
				//'wp.getPageList'          => 'this:wp_getPageList', // Not implemented
				'wp.getAuthors'           => 'this:wp_getAuthors',    // Only returns the current user
				'wp.getCategories'        => 'this:mw_getCategories', // Returns a list of forums
				'wp.getTags'              => 'this:wp_getTags',       // Returns the topic tags
// TODO				'wp.newCategory'          => 'this:wp_newCategory', // Create a new forum
// TODO				'wp.deleteCategory'       => 'this:wp_deleteCategory', // Deletes a forum
				//'wp.suggestCategories'    => 'this:wp_suggestCategories', // Not implemented
				//'wp.uploadFile'           => 'this:mw_newMediaObject', // Not imlpemented
// TODO				'wp.getCommentCount'      => 'this:wp_getCommentCount', // Returns a count of posts
// TODO				'wp.getPostStatusList'    => 'this:wp_getPostStatusList', // Returns available topic statuses
				//'wp.getPageStatusList'    => 'this:wp_getPageStatusList', // Not implemented
				//'wp.getPageTemplates'     => 'this:wp_getPageTemplates', // Not implemented
// TODO				'wp.getOptions'           => 'this:wp_getOptions', // Gets site options
// TODO				'wp.setOptions'           => 'this:wp_setOptions', // Sets site options
// TODO				'wp.getComment'           => 'this:wp_getComment', // Retreives a single post
// TODO				'wp.getComments'          => 'this:wp_getComments', // Retreives all posts in a topic
// TODO				'wp.deleteComment'        => 'this:wp_deleteComment', // Deletes a post
// TODO				'wp.editComment'          => 'this:wp_editComment', // Edits a post
// TODO				'wp.newComment'           => 'this:wp_newComment', // Creates a new post
// TODO				'wp.getCommentStatusList' => 'this:wp_getCommentStatusList', // Returns available post statuses
				
				// - Blogger API
				'blogger.getUsersBlogs'   => 'this:blogger_getUsersBlogs',
				'blogger.getUserInfo'     => 'this:blogger_getUserInfo',
// TODO				'blogger.getPost'         => 'this:blogger_getPost',
// TODO				'blogger.getRecentPosts'  => 'this:blogger_getRecentPosts',
// TODO				'blogger.getTemplate'     => 'this:blogger_getTemplate',
// TODO				'blogger.setTemplate'     => 'this:blogger_setTemplate',
// TODO				'blogger.newPost'         => 'this:blogger_newPost',
// TODO				'blogger.editPost'        => 'this:blogger_editPost',
// TODO				'blogger.deletePost'      => 'this:blogger_deletePost',

				// - MetaWeblog API (with MT extensions to structs)
// TODO				'metaWeblog.newPost'        => 'this:mw_newPost',
// TODO				'metaWeblog.editPost'       => 'this:mw_editPost',
// TODO				'metaWeblog.getPost'        => 'this:mw_getPost',
// TODO				'metaWeblog.getRecentPosts' => 'this:mw_getRecentPosts',
				'metaWeblog.getCategories'  => 'this:mw_getCategories',
				//'metaWeblog.newMediaObject' => 'this:mw_newMediaObject', // Not implemented

				// - MetaWeblog API aliases for Blogger API
				// see http://www.xmlrpc.com/stories/storyReader$2460
// TODO				'metaWeblog.deletePost'    => 'this:blogger_deletePost',
// TODO				'metaWeblog.getTemplate'   => 'this:blogger_getTemplate',
// TODO				'metaWeblog.setTemplate'   => 'this:blogger_setTemplate',
				'metaWeblog.getUsersBlogs' => 'this:blogger_getUsersBlogs',

				// - MovableType API
// TODO				'mt.getCategoryList'      => 'this:mt_getCategoryList',
// TODO				'mt.getRecentPostTitles'  => 'this:mt_getRecentPostTitles',
// TODO				'mt.getPostCategories'    => 'this:mt_getPostCategories',
// TODO				'mt.setPostCategories'    => 'this:mt_setPostCategories',
// TODO				'mt.supportedMethods'     => 'this:mt_supportedMethods',
// TODO				'mt.supportedTextFilters' => 'this:mt_supportedTextFilters',
// TODO				'mt.getTrackbackPings'    => 'this:mt_getTrackbackPings',
// TODO				'mt.publishPost'          => 'this:mt_publishPost',
			);
		}
	...
	/**
	 * bbPress publishing API - WordPress API compatibility methods
	 */
	 ...
	 *
	 * @since 1.0
	 * @return array|object An array containing site information or an IXR_Error object on failure
	 * @param array $args Arguments passed by the XML-RPC call
	 * @param string $args[0] The username for authentication
	 * @param string $args[1] The password for authentication
	 *
	 * XML-RPC request to get information about the site
	 * <methodCall>
	...
	{
		array_unshift( $args, 1 ); // Append the "blog" id
		return $this->blogger_getUsersBlogs( $args );
	}

	/**
	 * Retrieves the current user info only.
	 *
	 * @since 1.0
	 * @return array|object An array containing user information or an IXR_Error object on failure
	 * @param array $args Arguments passed by the XML-RPC call
	 ...
	 *
	 * XML-RPC request to get information about the current user
	 * <methodCall>
	...
	{
		do_action( 'bb_xmlrpc_call', 'wp.getAuthors' );
		...
		do_action( 'bb_xmlrpc_call_authenticated', 'wp.getAuthors' );
		...
		// Clients expect an array of many users with each node containing an array
		$authors = array( array(
	...
	/**
	 * bbPress publishing API - Blogger API compatibility methods
	 */
	 ...
	 * @return array|object An array containing site information or an IXR_Error object on failure
	 * @param array $args Arguments passed by the XML-RPC call
	 * @param integer $args[0] The "blog" id. If the function was called from BB_XMLRPC_Server::bb_wp_getUsersBlogs() this is set to 1
	 * @param string $args[1] The username for authentication
	 * @param string $args[2] The password for authentication
	 *
	 * XML-RPC request to get information about the site
	...
	{
		do_action( 'bb_xmlrpc_call', 'blogger.getUsersBlogs' );
		...
		do_action( 'bb_xmlrpc_call_authenticated', 'blogger.getUsersBlogs' );
		...
		// Find out if the user is an "admin" (for our purposes, someone who can manage options)
		$is_admin = bb_current_user_can( 'manage_options' );

		// Build an array of interesting info
		$struct = array(
			'isAdmin'  => $is_admin,
			'url'      => bb_get_uri(),
			'blogid'   => '1',
			'blogName' => bb_get_option( 'name' ),
			'xmlrpc'   => bb_get_uri( 'xmlrpc.php' )
		);
	...
	{
		do_action( 'bb_xmlrpc_call', 'blogger.getUserInfo' );
		...
		do_action( 'bb_xmlrpc_call_authenticated', 'blogger.getUserInfo' );
		...
		$struct = array(
			...
			'url'       => clean_url( $user->user_url, array( 'http', 'https' ), '' ),
	...
	/**
	 * bbPress publishing API - MetaWeblog API compatibility methods
	 */

	/**
	 * Retrieves data for all forums.
	 *
	 * @since 1.0
	 * @return array|object An array containing forums information or an IXR_Error object on failure
	 * @param array $args Arguments passed by the XML-RPC call
	 * @param integer $args[0] The "blog" id
	 * @param string $args[1] The username for authentication
	 * @param string $args[2] The password for authentication
	 *
	 * XML-RPC request to get information about all forums
	 * <methodCall>
	...
	{
		do_action( 'bb_xmlrpc_call', 'metaWeblog.getCategories' );
		...
		do_action( 'bb_xmlrpc_call_authenticated', 'metaWeblog.getCategories' );
		...
		$_forums = array();
		foreach ( $forums as $forum ) {
			$_forum = $this->prepare_forum( $forum );

			$struct = array();
			$struct['categoryId']          = $_forum['forum_id'];
			$struct['parentId']            = $_forum['forum_parent'];
			$struct['description']         = $_forum['forum_name'];
			$struct['categoryDescription'] = $_forum['forum_desc'];
			$struct['categoryName']        = $_forum['forum_name'];
			$struct['htmlUrl']             = wp_specialchars( get_forum_link( $_forum['forum_id'] ) );
			$struct['rssUrl']              = wp_specialchars( bb_get_forum_posts_rss_link( $_forum['forum_id'] ) );
