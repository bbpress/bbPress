...
function bbp_admin_tools_repair_help() {
	...
	$current_screen->add_help_tab(
		array(
			...
			'content' =>
						'<p>' . __( 'There is more detailed information available on the bbPress and BuddyPress codex for the following:', 'bbpress' ) . '</p>' .
						'<p>' .
							'<ul>' .
...
function bbp_admin_tools_converter_help() {
	...
	$current_screen->add_help_tab(
		array(
			...
			'content' =>
						'<p>' . __( 'This screen provides access to all of the bbPress Import Forums settings and resources.',                                      'bbpress' ) . '</p>' .
	...
	$current_screen->add_help_tab(
		array(
			...
			'content' =>
						'<p>' . __( 'In the Database Settings you have a number of options:', 'bbpress' ) . '</p>' .
						'<p>' .
							'<ul>' .
	...
	$current_screen->add_help_tab(
		array(
			...
			'content' =>
						'<p>' . __( 'In the Options you have a number of options:', 'bbpress' ) . '</p>' .
						'<p>' .
							'<ul>' .
