# bbPress 2.6 Contributor and Agent Handbook

This file applies to the 2.6 maintenance branch. It is an operational guide for
humans and coding agents working on bbPress. Prefer repository evidence over
memory, keep public changes reviewable, and leave the branch easier to release
than you found it.
...
- The deployment workflow is maintained on trunk. It prepares releases from exact canonical Subversion tags and requires an explicit deployment input plus protected environment approval before changing Plugin SVN.
