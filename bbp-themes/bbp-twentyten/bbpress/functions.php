...
function bbp_twentyten_enqueue_styles () {
	...
	wp_enqueue_style( 'bbp-twentyten-default', get_template_directory_uri() . '/css/twentyten.css', false, 20100312, 'screen' );

	// bbPress specific
	wp_enqueue_style( 'bbp-twentyten-bbpress', get_template_directory_uri() . '/css/bbpress.css', 'bbp-twentyten-default', 20100312, 'screen' );
}
