			...
			<fieldset id="tag-rename">
				...
				<form id="rename_tag" name="rename_tag" method="post" action="">
					...
					<div class="alignleft">
						...
						<input type="text" name="tag-name" size="20" maxlength="40" tabindex="2" value="<?php echo esc_attr( $term->name ); ?>" />
					</div>

					<div class="alignleft">
						<label for="tag-name"><?php _e( 'Slug:', 'bbpress' ); ?></label>
						<input type="text" name="tag-slug" size="20" maxlength="40" tabindex="4" value="<?php echo esc_attr( apply_filters( 'editable_slug', $term->slug ) ); ?>" />
					</div>

					<div class="alignright">
						<input type="submit" name="submit" tabindex="6" value="<?php esc_attr_e( 'Update', 'bbpress' ); ?>" /><br />
			...
			<fieldset id="tag-merge">
				...
				<form id="merge_tag" name="merge_tag" method="post" action="">
					...
					<div class="alignleft">
						...
						<input type="text" name="tag-name" size="22" tabindex="8" maxlength="40" />
					</div>

					<div class="alignright">
						<input type="submit" name="submit" tabindex="10" value="<?php esc_attr_e( 'Merge', 'bbpress' ); ?>"
			...
			<?php if ( current_user_can( 'delete_topic_tags' ) ) : ?>
				...
				<fieldset id="delete-tag">
					...
					<form id="delete_tag" name="delete_tag" method="post" action="">
						...
						<div class="alignright">
							<input type="submit" name="submit" tabindex="12" value="<?php _e( 'Delete', 'bbpress' ); ?>"
